...
class GraceShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "gracepics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Grace","Me"),
      new Picture("seniorsundaygrace","Virtual Senior Year")
    ];
...
ReactDOM.render(e(GraceShow),document.getElementById("slide-show1"));
