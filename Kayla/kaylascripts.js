...
class KaylaShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "kaylapics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Kayla","Me"),
      new Picture("halloweenkayla","It's Almost Halloween"),
      new Picture("lockedinhousekayla","Nothing Better To Do"),
      new Picture("skaterkayla","Skater Girl")
    ];
...
ReactDOM.render(e(KaylaShow),document.getElementById("slide-show1"));
