...
class MeganShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "meganpics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Megan","Me"),
      new Picture("moonmegan","The moon"),
      new Picture("seniorsundaymegan","Senior Sunday"),
      new Picture("skiingmegan","Skiing")
    ];
...
ReactDOM.render(e(MeganShow),document.getElementById("slide-show1"));
