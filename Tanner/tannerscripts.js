...
class TannerShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "tannerpics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Tanner","Me"),
      new Picture("helloworldtanner","Hello World"),
      new Picture("thisisdeadtanner","I'm Back"),
      new Picture("worthytanner","This is good")
    ];
...
ReactDOM.render(e(TannerShow),document.getElementById("slide-show1"));
