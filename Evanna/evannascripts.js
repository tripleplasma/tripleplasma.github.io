...
class EvannaShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "evannapics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Evanna","Me"),
      new Picture("backyardboyevanna","Dance with me"),
      new Picture("seniorsundayevanna","Ready for Christmas break"),
      new Picture("seniorsundayevanna2", "Doing Senior Year Online")
    ];
...
ReactDOM.render(e(EvannaShow),document.getElementById("slide-show1"));
