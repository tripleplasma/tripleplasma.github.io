...
class EvanShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "evanpics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Evan","Me"),
      new Picture("firstpostevan","Hi"),
      new Picture("hocoevan","Homecoming"),
      new Picture("seniorsundayevan","16min Lunches"),
    ];
...
ReactDOM.render(e(EvanShow),document.getElementById("slide-show1"));
