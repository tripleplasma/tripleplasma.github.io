...
class NatalieShow extends React.Component{
  render(){
    class Picture{
      constructor(picName,caption){
        this.url = "nataliepics/"+picName+".jpg";
        this.caption = caption;
      }
    }
    const pics = [
      new Picture("Natalie","Me"),
      new Picture("coolsocknatalie","Look at these socks!"),
      new Picture("skiingnatalie","Skiing"),
      new Picture("waitingtogoonlinenatalie","Waiting To Go Online")
    ];
...
ReactDOM.render(e(NatalieShow),document.getElementById("slide-show1"));
